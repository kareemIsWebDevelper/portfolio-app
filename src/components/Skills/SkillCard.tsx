...
const SkillCard: React.FC<SkillCardProps> = ({
  ...
  return (
    <Card hover className="group" style={{ animationDelay: `${delay}ms` }}>
      <div className="flex items-center mb-6">
        <div
          className={`p-3 rounded-2xl bg-gradient-to-r ${color} mr-4 group-hover:scale-110 transition-transform duration-300`}
        >
